...
void TiMidityCommandBuilder::build(QStringList& target, QString inputFilePath,
                                   TiMidityDevice outputDevice,
...
TiMidityCommandBuilder* TiMidityCommandBuilder::setConfigFilePath(
    QString configFilePath) {
    this->m_configFilePath = configFilePath;
    return this;
}

TiMidityCommandBuilder* TiMidityCommandBuilder::setSoundfontDirectoryPath(
    QString soundfontDirPath) {
    this->m_soundfontDirPath = soundfontDirPath;
    return this;
}

TiMidityCommandBuilder* TiMidityCommandBuilder::setReverbType(
    TiMidityReverbType reverbType) {
    this->m_reverbType = reverbType;
    return this;
}

TiMidityCommandBuilder* TiMidityCommandBuilder::setReverbValue(
    qint8 reverbValue) {
    this->m_reverbValue = reverbValue;
    return this;
}

TiMidityCommandBuilder* TiMidityCommandBuilder::setSampleRate(
    qint32 sampleRate) {
